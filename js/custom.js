jQuery(function ($) {
  ...
  $(document).ready(function () {
      ...
      $("#contact_form input[required], #contact_form textarea[required]").each(
        function () {
          ...
          if (!$.trim($(this).val())) {
            ...
            $("#contact_results")
              .html(
                '<br><div class="alert alert-danger">Please fill out the required fields.</div>'
              )
              .show();
        ...
        $.post(
          ...
          function (response) {
            if (response.type === "error") {
              ...
              var output =
                '<br><div class="success">' + response.text + "</div>";
    ...
    $(
      "#contact_form  input[required=true], #contact_form textarea[required=true]"
    ).keyup(function () {
